...
def inbody(request):
    ...
    if not uid:
        message = 'User information not found. Please log in.'
        return render(request, 'inbody.html', {'message': message, 'student_data': None, 'most_recent_record': None, 'difference': None})
